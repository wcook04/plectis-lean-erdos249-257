...
non-integral tail difference, not a heuristic phase test.  Thus the story
spine is: exact tail-difference endpoint, complete finite-certificate
interface, first-harmonic finite consumer.  The remaining edge is a cofinal
first-harmonic estimate producing such witnesses at unbounded parameters; no
estimate establishing that edge is proved.
...
\]
Then a certificate occurs at one of $N$ and $N+1$.  The finite consumer is
...
The formal module records several equivalent ways to route a cofinal arithmetic
producer through this finite consumer.  In particular, a cofinal pivot
...
$S$.  The direct finite consumer is
...
and the anti-reconstruction endpoint is
...
The module does not prove any of these cofinal arithmetic producers, so it does
...
Pivot anti-reconstruction & pairwise phase energy and exact window-pair endpoint & conditional / equivalence \\
