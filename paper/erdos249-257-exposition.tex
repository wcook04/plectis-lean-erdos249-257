...
% ---------------------------------------------------------------------------
\newcommand{\commit}{de7a3601c48e865f1992758daa9b4d6391c86d7e}
...
\href{https://github.com/wcook04/plectis-lean-erdos249-257}{\texttt{plectis-lean-erdos249-257}}, pinned at commit \href{\repobase}{\texttt{de7a360}}.}}
...
commit \href{\repobase}{\texttt{de7a360}}; the name in parentheses is the Lean
...
open series, and each module states that boundary in its header. One hedge is
repeated from the sources: the literature has not been audited for prior
statements of these lemmas, so they are offered as formal infrastructure, not
as claimed novelties.
...
the boundary condition forbids the homogeneous solution.
...
\end{result}
\noindent Formalized:
\lref{GenericTailOrbitRigidity.lean}{171}{temperedBinaryOrbit_eq_scaledTail}
(rigidity) and
\lref{GenericTailOrbitRigidity.lean}{259}{binaryCoeffSeries_rational_iff_exists_temperedBinaryOrbit}
...
(\lrefx{GenericTailOrbitRigidity.lean}{147}{doublingOrbit_eq_zero_of_tempered}).
...
(\lrefx{BooleanMobiusCarry.lean}{388}{erdosSupportSeries_two_eq_binaryCoeffSeries}).
...
\end{result}
\noindent Formalized:
\lref{BooleanMobiusCarry.lean}{88}{positiveSupportBitAF_mul_zeta},
\lref{BooleanMobiusCarry.lean}{106}{moebius_mul_supportCoeffAF}, and, with no
search or finiteness hypothesis, the converse
\lref{BooleanMobiusCarry.lean}{192}{eq_supportCoeffAF_booleanMobiusSupport_of_boolean};
the selected support is
\lrefx{BooleanMobiusCarry.lean}{151}{booleanMobiusSupport}.
...
(\lrefx{BooleanMobiusCarry.lean}{395}{erdosSupportSeries_rational_iff_exists_temperedCarry});
a displayed fraction $p/q$ corresponds to an orbit $U$ with multiplier $q$ and
initial value $U(0)=p$
(\lrefx{BooleanMobiusCarry.lean}{479}{support_fraction_iff_exists_temperedCarry});
and exact division recovers the coefficient from the orbit,
$\bigl(2U(N)-U(N+1)\bigr)/q=f_A(N+1)$
(\lrefx{BooleanMobiusCarry.lean}{508}{temperedCarry_quotient_eq_supportCoeff}).
The elementary divisor-pair bound $\tau(n)\le2\lfloor\sqrt n\rfloor$
(\lrefx{BooleanMobiusCarry.lean}{220}{card_divisors_le_two_mul_sqrt}) confines
the tails to a square-root strip, $T_{f_A}(N)\le2\sqrt N+4$
(\lrefx{BooleanMobiusCarry.lean}{301}{binaryCoeffTail_supportCoeff_le_two_sqrt_add_four}),
hence every orbit state to $0<U(N)\le q\,(2\sqrt N+4)$
(\lrefx{BooleanMobiusCarry.lean}{518}{temperedCarry_pos_of_exists_pos_mem},
\lrefx{BooleanMobiusCarry.lean}{532}{temperedCarry_le_denominator_mul_two_sqrt_add_four});
...
\end{result}
\noindent Formalized:
\lref{BooleanMobiusCarry.lean}{776}{exists_normalized_support_fraction_iff_exists_booleanMobiusCarry},
with the certificate packaged as
\lrefx{BooleanMobiusCarry.lean}{603}{BooleanMobiusCarryCertificate} and the
quotient normalized at index zero
(\lrefx{BooleanMobiusCarry.lean}{593}{carryQuotient}). A worked fixture keeps
the coordinates honest: the support $\{2,3\}$ has value
$\tfrac13+\tfrac17=\tfrac{10}{21}$
(\lrefx{BooleanMobiusCarry.lean}{882}{erdosSupportSeries_support23_eq_ten_div_twenty_one}),
its orbit is the pure period-six cycle $10,20,19,17,13,26$ with multiplier
$21$ (\lrefx{BooleanMobiusCarry.lean}{931}{carryOrbit23_isTempered}), and the
M\"obius transform of the carry quotient recovers exactly $\{2,3\}$
(\lrefx{BooleanMobiusCarry.lean}{968}{mobius_carryOrbit23_recovers_support}).
...
(\lrefx{RationalSupportCarrySkeleton.lean}{694}{exists_shifted_odd_tail_nat_states_of_support_fraction}).
...
\lref{RationalSupportCarrySkeleton.lean}{195}{sum_doublingResidue_eq_mul_wrapCount}
and \lrefx{RationalSupportCarrySkeleton.lean}{205}{doublingWrapCount_pos};
residues, digits, and counts are
\lrefx{RationalSupportCarrySkeleton.lean}{59}{doublingResidue},
\lrefx{RationalSupportCarrySkeleton.lean}{63}{doublingWrapDigit},
\lrefx{RationalSupportCarrySkeleton.lean}{67}{doublingWrapCount}.
...
\lref{RationalSupportCarrySkeleton.lean}{440}{one_doublingWrap_classification},
from the generic closed-cycle form
\lrefx{RationalSupportCarrySkeleton.lean}{378}{one_wrap_cycle_classification},
and instantiated at the true order $h=\operatorname{ord}_v(2)$
(\lrefx{RationalSupportCarrySkeleton.lean}{504}{one_oddOrder_doublingWrap_classification},
with \lrefx{RationalSupportCarrySkeleton.lean}{461}{oddDoublingOrder}). The
...
as the proof
(\lrefx{RationalSupportCarrySkeleton.lean}{2478}{orderWrapValidatedStartCount_eq_446},
\lrefx{RationalSupportCarrySkeleton.lean}{2482}{orderWrapValidation446_passes},
\lrefx{RationalSupportCarrySkeleton.lean}{2488}{orderWrap_minima_table_passes}).

The analytic bridge is Ces\`aro averaging. Write $\rho(A)=\sum_{a\in A}1/a$
for the reciprocal mass
(\lrefx{RationalSupportCarrySkeleton.lean}{816}{reciprocalMass}). When the
...
(\lref{RationalSupportCarrySkeleton.lean}{971}{tendsto_supportCoeff_mean_reciprocalMass},
\lrefx{RationalSupportCarrySkeleton.lean}{1062}{tendsto_binaryCoeffTail_supportCoeff_mean_reciprocalMass}).
The divergent case is carried as an explicit disjunction, not through the
convention that a divergent \texttt{tsum} is zero
(\lrefx{RationalSupportCarrySkeleton.lean}{822}{ReciprocalMassDivergesOrAtLeast}).
Each tail state splits exactly as $u(N)=v\,e_N+r_N$ with integral excess
$e_N=\lfloor u(N)/v\rfloor\ge0$
(\lrefx{RationalSupportCarrySkeleton.lean}{527}{oddTailExcess}).
...
\end{result}
\noindent Formalized:
\lref{RationalSupportCarrySkeleton.lean}{1479}{support_fraction_oddOrder_wrapRatio_le_reciprocalMass},
\lref{RationalSupportCarrySkeleton.lean}{1503}{one_div_oddOrder_le_reciprocalMass_of_support_fraction},
the divergence-honest form
\lloc{RationalSupportCarrySkeleton.lean}{1542}\ (\,\idn{support_fraction_one_div_oddOrder_reciprocalMassDivergesOrAtLeast}\,),
and the excess mean
\lref{RationalSupportCarrySkeleton.lean}{1359}{tendsto_oddTailExcess_mean}
(fraction-facing shifted form
\lrefx{RationalSupportCarrySkeleton.lean}{1602}{exists_shifted_oddTailExcess_mean_of_support_fraction},
named-limit form
\lrefx{RationalSupportCarrySkeleton.lean}{1378}{reciprocalMass_eq_wrapRatio_add_oddTailExcessMean}).
...
\lref{RationalSupportCarrySkeleton.lean}{2062}{booleanCollision_wrap_bound_of_common_multiple}
(denominator-shifted form
\lloc{RationalSupportCarrySkeleton.lean}{1988}\ (\,\idn{shiftedBooleanCollision_wrap_bound_of_common_multiple}\,)),
the carry equation
\lrefx{RationalSupportCarrySkeleton.lean}{1676}{supportCoeff_add_oddTailExcess_succ_eq_wrap_add_two_excess},
and the dyadic corollary
\lref{RationalSupportCarrySkeleton.lean}{2225}{dyadic_support_fraction_reciprocalMass_diverges_or_gt_one}
(via \lloc{RationalSupportCarrySkeleton.lean}{2141}\ (\,\idn{one_lt_reciprocalMass_of_dyadic_support_fraction_of_two_pos_mem}\,)).
...
\lref{RationalSupportCarrySkeleton.lean}{2402}{exists_unbounded_shifted_odd_tail_nat_state_of_support_fraction},
from
\lrefx{RationalSupportCarrySkeleton.lean}{2345}{shifted_state_unbounded_of_infinite_support}
and the local inequality
\lrefx{RationalSupportCarrySkeleton.lean}{2253}{one_add_mul_card_le_two_mul_shifted_state};
the $\{2,3\}$ fixture revalidates it at sixty-six common multiples
(\lrefx{RationalSupportCarrySkeleton.lean}{2427}{carryOrbit23_common_multiple_bound_validation66}).
...
(\lrefx{GreedyAchievementSet.lean}{504}{positiveMersenneSupportValue_eq_erdosSupportSeries};
the set is \lrefx{GreedyAchievementSet.lean}{521}{mersenneAchievementSet}). In
...
\end{result}
\noindent Formalized:
\lref{GreedyAchievementSet.lean}{183}{mersenneTail_lt_weight},
\lref{GreedyAchievementSet.lean}{422}{mersenneGap_isBigOWith} (explicit bound
\lrefx{GreedyAchievementSet.lean}{397}{mersenneGap_asymptotic_bound}),
\lref{GreedyAchievementSet.lean}{750}{mem_mersenneAchievementSet_iff_greedy_survival},
and
\lref{GreedyAchievementSet.lean}{759}{positiveMersenneSupportValue_injective_normalized},
transferred to the kernel series at
\lrefx{GreedyAchievementSet.lean}{768}{erdosSupportSeries_two_injective_normalized}.
...
\end{result}
\noindent Formalized:
\lref{GreedyAchievementSet.lean}{574}{cast_greedyMersenneRemainderRat};
\lref{GreedyAchievementSet.lean}{827}{certifiedGreedyMersenneDeath_not_mem},
with the certificate
\lrefx{GreedyAchievementSet.lean}{821}{CertifiedGreedyMersenneDeath} and the
enclosure \lrefx{GreedyAchievementSet.lean}{788}{mersenneTailUpperRat};
\lref{GreedyAchievementSet.lean}{849}{three_fourths_not_mem_mersenneAchievementSet};
and \lref{GreedyAchievementSet.lean}{933}{rational_member_support_bit_iff}.
...
Each row links to the declaration at commit \href{\repobase}{\texttt{de7a360}}.
...
tail-orbit rationality criterion & \lloc{GenericTailOrbitRigidity.lean}{259}\ {\footnotesize\idn{binaryCoeffSeries_rational_iff_exists_temperedBinaryOrbit}}\\
Boolean carry certificate $\Leftrightarrow$ support fraction & \lloc{BooleanMobiusCarry.lean}{776}\ {\footnotesize\idn{exists_normalized_support_fraction_iff_exists_booleanMobiusCarry}}\\
one-wrap classification & \lloc{RationalSupportCarrySkeleton.lean}{440}\ {\footnotesize\idn{one_doublingWrap_classification}}\\
order-wrap mass bound & \lloc{RationalSupportCarrySkeleton.lean}{1503}\ {\footnotesize\idn{one_div_oddOrder_le_reciprocalMass_of_support_fraction}}\\
unbounded carry states & \lloc{RationalSupportCarrySkeleton.lean}{2402}\ {\footnotesize\idn{exists_unbounded_shifted_odd_tail_nat_state_of_support_fraction}}\\
greedy membership criterion & \lloc{GreedyAchievementSet.lean}{750}\ {\footnotesize\idn{mem_mersenneAchievementSet_iff_greedy_survival}}\\
\bottomrule
\end{tabular}
\end{center}
