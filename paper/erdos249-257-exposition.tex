...
arithmetic-function and Dirichlet-convolution background~\cite{apostol}, and
Merca--Schmidt give a modern treatment of Lambert-series factorisations
~\cite{mercaschmidt}. Walking the ladder by convolution gives five values with
...
classical Lambert-series infrastructure~\cite{apostol,mercaschmidt}; the
...
geometry for these Lambert subseries~\cite{kovactao}; this is the relevant
Lambert-series instance of Kakeya's classical strict-tail criterion for
subsum sets~\cite{kakeya1914}. The local contribution is the executable Lean
interface, quantitative enclosure, and finite non-membership certificates over
that known geometry.
...
\bibitem{mercaschmidt} M.~Merca and M.~D. Schmidt, \emph{Generating special arithmetic
  functions by Lambert series factorizations}, arXiv:1706.00393 (2017).
