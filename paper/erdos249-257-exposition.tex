...
% ---------------------------------------------------------------------------
\newcommand{\commit}{769e93a0def435ec677631610bb5bbaba021131b}
...
This paper is linked to commit \href{\repobase}{\texttt{769e93a}}; each blue
...
The exact public artefact cited here is commit \texttt{769e93a}~\cite{artifact}.
...
Each row links to the declaration at commit \href{\repobase}{\texttt{769e93a}}.
...
\bibitem{artifact} W.~Cook, \emph{Erd\H{o}s \#249/\#257 Lean formalisation},
  public source artefact at commit \texttt{769e93a} (2026),
  \href{https://github.com/wcook04/plectis-lean-erdos249-257}{GitHub repository}.
\end{thebibliography}
