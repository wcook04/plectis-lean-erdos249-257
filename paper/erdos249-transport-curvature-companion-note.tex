...
cofinal arithmetic or harmonic producer is proved.
\end{abstract}
...
\[
\begin{aligned}
 C&=\sum_{N\in\mathcal G}R_N(P_N-\overline P_{m_N}),&
 M&=\sum_{N\in\mathcal G}R_N\overline P_{m_N},\\
...
estimate is assumed there.  The theorem proves the exact algebraic consumer.
...
Large-prime pivot & exact four-term split and one-sided budget & \mbox{conditional reduction} \\
