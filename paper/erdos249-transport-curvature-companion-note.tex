...
paper isolates exact consumers and exact obstructions; it does not supply the
cofinal arithmetic producer needed to settle the problem.
...
budget would imply irrationality.  This is the analytic consumer between the
transport identities and the phase geometry, not an additional proof of the
missing estimates.
...
global consumers: a sufficient harmonic-budget route and an equivalent
...
modules.  Affine transport explains which divisor channels a finite
...
first of these global consumers arithmetically explicit, while the
...
\end{tabular}
\end{center}
No cofinal arithmetic or harmonic producer is proved.  Therefore the chain
stops at exact finite consumers and equivalent reformulations, and
