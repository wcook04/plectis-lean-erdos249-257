...
- Entire checked corpus: 624 modules, 12,322 declarations, 11,342 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
