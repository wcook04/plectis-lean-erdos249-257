...
- Entire checked corpus: 632 modules, 12,476 declarations, 11,457 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
