...
- Entire checked corpus: 633 modules, 12,490 declarations, 11,467 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
