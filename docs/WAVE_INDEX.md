...
- Entire checked corpus: 613 modules, 12,029 declarations, 11,088 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
