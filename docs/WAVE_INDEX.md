...
- Entire checked corpus: 635 modules, 12,578 declarations, 11,539 theorem-like declarations, and 2,925 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
