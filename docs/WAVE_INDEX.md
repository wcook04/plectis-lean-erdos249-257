...
- Entire checked corpus: 611 modules, 11,996 declarations, 11,059 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
