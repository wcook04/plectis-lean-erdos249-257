...
- Entire checked corpus: 600 modules, 8,093 declarations, 7,174 theorem-like declarations, and 1,681 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
