...
given separately in `paper/erdos249-transport-curvature-companion-note.tex`.
...
- Entire checked corpus: 635 modules, 12,577 declarations, 11,538 theorem-like declarations, and 2,925 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
