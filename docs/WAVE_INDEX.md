...
- Entire checked corpus: 608 modules, 11,966 declarations, 11,035 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
