...
- The diagonal-pincer family contains 481 isolated prime-certificate modules and 12 scale aggregators. The shards are indexed through aggregators rather than presented as separate mathematical claims.
- Entire checked corpus: 603 modules, 9,987 declarations, 9,064 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
