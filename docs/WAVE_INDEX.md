...
- Entire checked corpus: 577 modules, 7,477 declarations, 6,687 theorem-like declarations, and 1,681 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
