...
- Entire checked corpus: 625 modules, 12,328 declarations, 11,343 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
