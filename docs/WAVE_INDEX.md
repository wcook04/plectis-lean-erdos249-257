...
- Entire checked corpus: 567 modules, 7,198 declarations, 6,454 theorem-like declarations, and 1,681 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
