...
- The diagonal-pincer family contains 481 isolated prime-certificate modules and 13 scale aggregators. The shards are indexed through aggregators rather than presented as separate mathematical claims.
- Entire checked corpus: 604 modules, 10,329 declarations, 9,404 theorem-like declarations, and 2,923 generated-certificate declarations. The release gate rejects `sorry`, `admit`, custom `axiom` declarations, and `native_decide`.
