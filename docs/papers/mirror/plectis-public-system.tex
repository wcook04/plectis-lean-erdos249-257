...
sentence by sentence.  I designed and directed an agentic workflow that
drafted and revised the prose and supporting code from objectives, evidence,
and review criteria that I supplied.  I selected the claims, required
revisions, reviewed and approved the published version, and take full
responsibility for it.  The agents are production tools, not authors.
Section~\ref{sec:problem} and Section~\ref{sec:hand} examine what follows from
this.}
...
At the time of this work I was 22, an economics undergraduate, working
independently and without external funding. Over about ten months I built the
private system by directing AI coding agents, software tools that can edit,
run, and revise code across a task. I set objectives and review criteria,
...
independent authority. Section~\ref{sec:problem} states this in the first
person and Section~\ref{sec:hand} examines the concentration of choice it
leaves; both are part of this paper's subject rather than background to it. The
account of private production is testimony about origin, and the paper's
publicly testable claims depend only on the published files, commands, and
stated limits identified here.
