...
standalone exponent-six finite diagonal kill without `native_decide`.
-/
...
/-! ## The standalone exponent-six finite diagonal certificate -/
...
#print axioms certifiedKill_diagonal_t64
